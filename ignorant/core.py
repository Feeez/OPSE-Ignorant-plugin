...
def get_functions(modules,args=None):
    ...
    for module in modules:
        if len(module.split(".")) > 5 : # THIS FUCKING LINE COST ME AT LEAST 3 HOURS ! IMPORT CHECK IS DONE BY COUNTING THE NUMBER OF POINTS IN THE MODULE PATH. DUE TO THE NEW ARBORESCENCE tools.opse-ignorant-plugin.ignorant HAVE BEEN ADDED, INCREASING THE NUMBER OF POINTS, PUTTING A REAL MESS IN EVERYTHING
            modu = modules[module]
            site = module.split(".")[-1]
